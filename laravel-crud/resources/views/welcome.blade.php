...
@section('content')
<div class="min-h-screen bg-green-50 -m-6">
    
    <!-- Hero Section -->
    <div class="relative overflow-hidden">
        <!-- Background Pattern -->
        <div class="absolute inset-0 opacity-5">
            <div class="absolute inset-0" style="background-image: radial-gradient(circle at 25% 25%, #16a34a 0%, transparent 50%), radial-gradient(circle at 75% 75%, #16a34a 0%, transparent 50%)"></div>
        </div>
        ...
        <nav class="relative z-10 flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
            ...
            <div class="hidden md:flex space-x-8">
                <a href="#" class="text-gray-600 hover:text-green-600 font-medium transition-colors">Documentación</a>
                <a href="#" class="text-gray-600 hover:text-green-600 font-medium transition-colors">Demo</a>
                <a href="#" class="text-gray-600 hover:text-green-600 font-medium transition-colors">Características</a>
                <a href="#" class="text-gray-600 hover:text-green-600 font-medium transition-colors">Blog</a>
            </div>
        </nav>
        ...
        <div class="relative z-10 text-center px-6 py-20 max-w-6xl mx-auto">
            ...
            <div class="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 mb-8 shadow-lg border border-white/20">
                <span class="text-green-600 font-semibold">2025 Actualización</span>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                <a href="{{ route('items.index') }}" 
                   class="bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-8 rounded-xl text-lg shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 flex items-center space-x-2">
    ...
    <div class="py-20 bg-white/50 backdrop-blur-sm">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Feature 1 -->
                <div class="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-green-200">
    ...
    <!-- Demo Section -->
    <div id="demo" class="py-20 bg-green-100">
        <div class="max-w-6xl mx-auto px-6 text-center">
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200 mb-12">
                ...
                <div class="p-8 bg-green-50 min-h-64 flex items-center justify-center">
            ...
            <a href="{{ route('items.index') }}" 
               class="inline-flex items-center space-x-3 bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-10 rounded-xl text-lg shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
    ...
    <!-- Footer -->
    <footer class="bg-green-800 text-white py-16">
        <div class="max-w-6xl mx-auto px-6">
